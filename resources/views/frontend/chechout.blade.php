					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="{{ route('cart.index') }}" class="active"><i class="fa fa-shopping-cart"></i> Cart</a></li>
						...
						<div class="bill-to">
							...
							<form action="{{ route('checkout.store') }}" method="POST">
								...
								<div class="form-one">
									...
									<label><input type="checkbox" name="shipping_to_bill"> Shipping to bill address</label> <br>
								</div>
								<div class="form-two">
									<p>Payment Method</p>
									<label><input type="radio" name="payment_method" value="handcash"> Hand Cash</label> <br>
									<label><input type="radio" name="payment_method" value="card"> Credit Card</label> <br>
							...
							<tr>
								...
								<td class="cart_quantity">
									<div class="cart_quantity_button">
										<a class="cart_quantity_up" href="{{ route('cart.increase', $item->rowId) }}"> + </a>
										<input class="cart_quantity_input" type="text" name="quantity" value="{{ $item->qty }}" autocomplete="off" size="2">
										<a class="cart_quantity_down" href="{{ route('cart.decrease', $item->rowId) }}"> - </a>
									</div>
								</td>
								<td class="cart_total">
				...
				<div class="row">
					<div class="col-sm-2">
						<div class="companyinfo">
							<h2><span>lara-e</span>-shopper</h2>
